...
public class Cards {
	 ...
	 * @param table - tabelul care contribuie la alcatuirea elementelor cartilor
	...
	/**
	 * Constructorul Cards() fara argumente este folosit pentru a crea un nou pachet de carti 
	 * prin intermediul celor 5 tipuri de carti mostenite din aceasta clasa, si anume: 
	 * FireCard 
	 * WaterCard 
	 * EarthCard 
	 * MetalCard 
	...
	/**
	 * Functia LoadCards() are rolul de a crea un pachet cu toate cartile disponibile din joc.
	 */
	...
	/**
	 * Functia AfisarePachetComplet() are rolul de a afisa toate cartile disponibile din joc.
	 */
